...
public class Activity_Add_Customer extends AppCompatActivity implements View.OnClickListener {
    /**
     * Shop Name
     */
    ...
    private void initView() {
        ...
        cd = new ConnectionDetector(Activity_Add_Customer.this);
        getSharedPref = new SharedPref(Activity_Add_Customer.this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ed_distributor:
                intent = new Intent(Activity_Add_Customer.this, Activity_Select_City.class);
...
//        String area = ed_area.getText().toString().trim() + "";
        ...
        try {
            progDialog = new ProgressDialog(Activity_Add_Customer.this);
...
//                            if (response.body().getFLG() == 1) {
                            dialogSuccess = new SweetAlertDialog(Activity_Add_Customer.this, SweetAlertDialog.SUCCESS_TYPE);
