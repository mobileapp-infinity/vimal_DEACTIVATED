...
public class FDPAttended extends AppCompatActivity {
    ...
    private static ListView lv_fdp;
    ...
    public static FDPAttendedPojo fdpAttendedPojo;
    static Boolean isChecked_API = false;
    static RequestQueue queue;
    static FDpAttendedAdapter fDpAttendedAdapter;
    static Activity activity;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fdpattended);
        ...
        activity = FDPAttended.this;
        fDpAttendedAdapter = null;
        ...
        cb_check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                listall = new ArrayList<>();
                listall.clear();
                fdpAttendedPojo = new FDPAttendedPojo();
                //  lvapproveleave.scrollTo(0,0);

                FdpListing(1, isChecked);
    ...
    public static List<FDPAttendedPojo.DataBean> listall;
    public static void FdpListing(final int page_no, final boolean isChecked)
    {
        ...
        if (isChecked)
        {
            url = URLS.Get_FDP_Attended_list + "&user_id=" + mySharedPrefereces.getUserID() + "&emp_id=" + mySharedPrefereces.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id=" + "0" + "";
        } else {

            url = URLS.Get_FDP_Attended_list + "&user_id=" + mySharedPrefereces.getUserID() + "&emp_id=" + mySharedPrefereces.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id=" + "0" + "";
        }
        url = url.replace(" ", "%20");

        System.out.println("Get_FDP_Attended_list URL on resume ::::::  " + url + "");
...
//                DialogUtils.hideProgressDialog();
                ...
                System.out.println("response size in leave listing Get_FDP_Attended_list:::::::::::::::::::::::::::::::::::::: " + response.length());
                if (response.length() > 10) {
                    ...
                    System.out.println("Get_FDP_Attended_list listing data size :::::::::::::::::::::::::::::::::::::" + fdpAttendedPojo.getData().size());

                    listall.addAll(fdpAttendedPojo.getData());
                            ...
                            if (fdpAttendedPojo.getData().get(0) != null) {
                                if (fdpAttendedPojo.getData().size() > 0) {
                                    ...
                                    if (lv_fdp != null) {
                                        ...
                                        if (fDpAttendedAdapter != null && page_no > 1)
//                        if (adapter != null && pageNo > 1)
                                        {
                                            System.out.println("page if  ");
                                            fDpAttendedAdapter.notifyDataSetChanged();
                                        } else {
                                            System.out.println("page else  ");

                                            fDpAttendedAdapter = new FDpAttendedAdapter(activity, fdpAttendedPojo, listall, isChecked);
//                                             cancelLeavesAdapter.notifyDataSetChanged();
                                            lv_fdp.setAdapter(fDpAttendedAdapter);

                                            lv_fdp.setOnScrollListener(new EndlessScrollListener()
                                            {
                                                @Override
...
//                DialogUtils.hideProgressDialog();
    ...
    private void initView() {
        ...
        lv_fdp = (ListView) findViewById(R.id.lv_fdp);
        iv_back = (ImageView) findViewById(R.id.iv_back);
        txt_act = (CustomBoldTextView) findViewById(R.id.txt_act);
