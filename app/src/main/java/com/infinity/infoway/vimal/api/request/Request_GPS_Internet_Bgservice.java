...
public class Request_GPS_Internet_Bgservice {
...
//    @SerializedName("json_details_string")
    ...
    @Expose
    private String json_details_string ;
    ...
    public Request_GPS_Internet_Bgservice(String app_version, String android_id, String device_id, String user_id, String key, String comp_id, String type, String json_details_string) {
        ...
        this.type = type;
        this.json_details_string = json_details_string;
    }
  ...
  /*  public String toString() {
    ...
    public String toString() {
        return "GPS_Internet_Bgservice {" +
                ...
                ",type='" + type + '\'' +
                ",json_detail='" + json_details_string + '\'' +
                '}';
    }
}
