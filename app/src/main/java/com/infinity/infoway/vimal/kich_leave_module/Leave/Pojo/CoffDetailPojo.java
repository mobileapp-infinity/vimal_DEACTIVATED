...
public class CoffDetailPojo
{
    ...
    public static class DataBean {
         ...
         * edew_id : 30
         * req_emp_id : 1008
         * ex_req_from_date : 31-03-2019 7:00AM
         * ex_req_to_date : 31-03-2019 3:00PM
         * ex_req_tot_emp : 1
         * ex_req_reason : gdfgh
         * ex_req_emp_id : 703
         * ex_req_by_emp : HR HR
         * ex_req_emp : KAMLESH PATEL
         * app_status : Pending
         * modify_dnt : null
         * create_dnt : 2019-03-29T20:53:26.537
         */
