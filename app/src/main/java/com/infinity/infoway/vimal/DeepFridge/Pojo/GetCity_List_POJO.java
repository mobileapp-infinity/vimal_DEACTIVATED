...
public class GetCity_List_POJO {
    public int TOTAL;
    public List<RECORDSBean> RECORDS = new ArrayList<>();
    public String MESSAGE;

    public GetCity_List_POJO(String json) throws Exception {
        this(new JSONObject(json));
    }

    public GetCity_List_POJO(JSONObject json) throws Exception {
    ...
    public static class RECORDSBean {
        ...
        public RECORDSBean(JSONObject json) throws Exception {
            id = json.optInt("id");
            cit_name = json.optString("cit_name");
