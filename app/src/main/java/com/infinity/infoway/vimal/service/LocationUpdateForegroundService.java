package com.infinity.infoway.vimal.service;//package com.infinity.kich.service;
//
...
//import com.infinity.kich.Api.request.Request_GPS_Internet_Bgservice;
//import com.infinity.kich.Api.request.Request_Insert_Location_Sync;
//import com.infinity.kich.Api.response.Connection_on_off_notificationResponse;
//import com.infinity.kich.Api.response.GPS_Internet_BgserviceResponse;
...
//import com.infinity.kich.model.InternetMasterBean;
//import com.infinity.kich.model.ServiceMasterBean;
//import com.infinity.kich.util.common.LocationUtil;
//
//
...
//            "com.infinityinfoway.davat.service.updatedata";
//
...
//            if (isTodayPunchINDone() && !isTodayPunchOutDone()) {
//                System.out.println("Activity_Home.FLAG_4_BACK_START_PG_AGAIN " + MainActivity.FLAG_4_BACK_START_PG_AGAIN + "");
//                if (MainActivity.FLAG_4_BACK_START_PG_AGAIN) {
...
//        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.kichlogonew);
//
//        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
//                .setContentText(text)
//                .setContentTitle(LocationUtil.getLocationTitle(this))
...
//                .setSmallIcon(R.drawable.kichlogonew)
//                .setTicker(text)
