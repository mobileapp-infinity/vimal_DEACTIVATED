...
public class Consultancy extends AppCompatActivity {
    ...
    private static ListView lv_consultuncy;
    ...
    public static ConsultuncyPojo consultuncyPojo;
    static Boolean isChecked_API = false;
    static RequestQueue queue;
    static ConsultuncyAdapter consultuncyAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_act.setText("Consultancy");

        activity = Consultancy.this;
        consultuncyAdapter = null;
        ...
        cb_check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                listall = new ArrayList<>();
                listall.clear();
                consultuncyPojo = new ConsultuncyPojo();
                //  lvapproveleave.scrollTo(0,0);

                ConsultuncyApproval(1, isChecked);
...
//                ApprovleaveListingAPICall(PAGE_NUMBER, isChecked);
    ...
    public static List<ConsultuncyPojo.DataBean> listall;
   public static void ConsultuncyApproval(final int page_no, final boolean isChecked)
    {
        ...
        if (isChecked)
        {
            url = URLS.Get_Consultancy_list + "&user_id=" + mySharedPrefereces.getUserID() + "&emp_id=" + mySharedPrefereces.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id=" + "0" + "";
        } else {

            url = URLS.Get_Consultancy_list + "&user_id=" + mySharedPrefereces.getUserID() + "&emp_id=" + mySharedPrefereces.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id=" + "0" + "";
        }
        url = url.replace(" ", "%20");
...
//                DialogUtils.hideProgressDialog();
                ...
                if (response.length() > 10) {
                    ...
                    System.out.println("Get_Patent_awarded_list listing data size :::::::::::::::::::::::::::::::::::::" + consultuncyPojo.getData().size());

                    listall.addAll(consultuncyPojo.getData());
                        ...
                        if (consultuncyPojo.getData() != null) {
                            if (consultuncyPojo.getData().get(0) != null) {
                                if (consultuncyPojo.getData().size() > 0) {
                                    ...
                                    if (lv_consultuncy != null) {

                                        if (consultuncyAdapter != null && page_no > 1)
//                        if (adapter != null && pageNo > 1)
                                        {
                                            System.out.println("page if  ");
                                            consultuncyAdapter.notifyDataSetChanged();
                                        } else {
                                            System.out.println("page else  ");

                                            consultuncyAdapter = new ConsultuncyAdapter(activity, consultuncyPojo, listall, isChecked);
//                                             cancelLeavesAdapter.notifyDataSetChanged();
                                            lv_consultuncy.setAdapter(consultuncyAdapter);

                                            lv_consultuncy.setOnScrollListener(new EndlessScrollListener()
                                            {
                                                @Override
                                                public boolean onLoadMore(int page, int totalItemsCount)
                                                {
                                                    ...
                                                    ConsultuncyApproval(page, isChecked_API);
//}
                                                    return true;
                                                }
                                            });
...
//                DialogUtils.hideProgressDialog();
    ...
    protected void onResume() {
        ...
        else
        {
            ...
            ConsultuncyApproval(1, isChecked_API);
    ...
    private void initView()
    {
        ...
        lv_consultuncy = (ListView) findViewById(R.id.lv_consultuncy);
        iv_back = (ImageView) findViewById(R.id.iv_back);
        txt_act = (CustomBoldTextView) findViewById(R.id.txt_act);
