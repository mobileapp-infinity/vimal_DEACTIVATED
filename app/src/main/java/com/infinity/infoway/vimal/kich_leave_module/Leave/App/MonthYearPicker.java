...
public class MonthYearPicker {
    ...
    private static final String[] PICKER_DISPLAY_MONTHS_NAMES = new String[]{"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct","Nov", "Dec"};

    private static final String[] PICKER_DISPLAY_MONTHS_NAME = new String[]{"jan", "feb", "march", "apr", "may", "june", "jul", "aug", "sept", "oct", "nov", "dec"};
