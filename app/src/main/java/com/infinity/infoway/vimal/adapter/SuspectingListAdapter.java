...
public class SuspectingListAdapter extends RecyclerView.Adapter<SuspectingListAdapter.MyViewHolder>{

    private OnItemClickListner onItemClickListner;
    private Context context;
    private List<SuspectingReport.RECORDSBean> viewCallList;
    ...
    public SuspectingListAdapter(Context context, List<SuspectingReport.RECORDSBean> viewCallList, OnItemClickListner onItemClickListner) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView txt_shop_name, txt_contact_person, txt_mobile, txt_city,txt_date_time,txt_view_edit;
        ImageView img_photo;
        ...
        public MyViewHolder(View view) {
            ...
            txt_view_edit=view.findViewById(R.id.txt_view_edit);
        }

        public void bindListener(final int position, final SuspectingReport.RECORDSBean dataModel) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_item_view_suspecting, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        if(viewCallList!=null && viewCallList.size()>0) {
            final SuspectingReport.RECORDSBean data = viewCallList.get(position);
            ///bind listner
...
//                }else{
          //  holder.txt_shop_name.setText("Emp. name : "+data.getEmp_name() + "");
            holder.txt_shop_name.setText(""+data.getEmp_name() + "");
            //}


            if (!TextUtils.isEmpty(data.getSe_agency_name()+"")) {
//                holder.txt_contact_person.setText("Agency    : "+ data.getSe_agency_name ()+"");
                holder.txt_contact_person.setText(""+ data.getSe_agency_name ()+"");
            }

            if (!TextUtils.isEmpty(data.getSe_mobile_no()+"")) {
//                holder.txt_mobile.setText("Mobile    : "+data.getSe_mobile_no()+"");
                holder.txt_mobile.setText(""+data.getSe_mobile_no()+"");
            }

            //if ((!TextUtils.isEmpty(data.getSe_owner_name()))) {
                holder.txt_city.setVisibility(View.VISIBLE);
//                holder.txt_city.setText("Owner     : "+data.getSe_owner_name());
                holder.txt_city.setText(""+data.getSe_owner_name());
           // }
//            else {
...
//                holder.txt_date_time.setText("Date      : "+data.getDate()+"");
                holder.txt_date_time.setText(""+data.getDate()+"");

                holder.txt_view_edit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        onItemClickListner.onItemClicked(position, data,  holder.txt_view_edit);
                    }
                });
