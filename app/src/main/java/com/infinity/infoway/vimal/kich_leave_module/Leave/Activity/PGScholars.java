...
public class PGScholars extends AppCompatActivity {
    ...
    public static PgScolarsGuidedPojo pgScolarsGuidedPojo;
    static Boolean isChecked_API = false;
    static RequestQueue queue;
    static PgScholars_GuidedAdapter pgScholarsGuidedAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgscholars);
        ...
        txt_act.setText("PG Scholars");
        initView();

        activity = PGScholars.this;
        pgScholarsGuidedAdapter = null;
        ...
        cbcheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                listall = new ArrayList<>();
                listall.clear();
                pgScolarsGuidedPojo = new PgScolarsGuidedPojo();

                Pgscholarsapprovelist(1,isChecked);
...
//                ApprovleaveListingAPICall(PAGE_NUMBER, isChecked);
    ...
    public static List<PgScolarsGuidedPojo.DataBean> listall;

    public static void Pgscholarsapprovelist(final int page_no, boolean isc)
    {
        ...
        if (isc)
        {
            url = URLS.Get_PG_Scholars_Guided_list + "&user_id=" + mySharedPrefereces.getUserID() + "&emp_id=" + mySharedPrefereces.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id=" + "0" + "";
        } else {

            url = URLS.Get_PG_Scholars_Guided_list + "&user_id=" + mySharedPrefereces.getUserID() + "&emp_id=" + mySharedPrefereces.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id=" + "0" + "";
        }
        url = url.replace(" ", "%20");

        System.out.println("Get_PG_Scholars_Guided_list URL on resume ::::::  " + url + "");
...
//                DialogUtils.hideProgressDialog();
                ...
                System.out.println("response size in leave listing Get_PG_Scholars_Guided_list:::::::::::::::::::::::::::::::::::::: " + response.length());
                if (response.length() > 10) {
                    ...
                    System.out.println("Get_PG_Scholars_Guided_list listing data size :::::::::::::::::::::::::::::::::::::" + pgScolarsGuidedPojo.getData().size());

                    listall.addAll(pgScolarsGuidedPojo.getData());
                            ...
                            if (pgScolarsGuidedPojo.getData().get(0) != null)
                            {
                                if (pgScolarsGuidedPojo.getData().size() > 0)
                                {
                                    ...
                                    if (lvpgscholar != null)
                                    {
                                        ...
                                        if (pgScholarsGuidedAdapter != null && page_no > 1)
                                        {
                                            System.out.println("page if  ");
                                            pgScholarsGuidedAdapter.notifyDataSetChanged();
                                        } else {
                                            System.out.println("page else  ");

                                            pgScholarsGuidedAdapter = new PgScholars_GuidedAdapter(activity, pgScolarsGuidedPojo, listall, isChecked_API);
//                                             cancelLeavesAdapter.notifyDataSetChanged();
                                            lvpgscholar.setAdapter(pgScholarsGuidedAdapter);

                                            lvpgscholar.setOnScrollListener(new EndlessScrollListener()
                                            {
                                                @Override
                                                public boolean onLoadMore(int page, int totalItemsCount)
                                                {
                                                    ...
                                                    Pgscholarsapprovelist(page, isChecked_API);
//}
                                                    return true;
                                                }
                                            });
...
//                DialogUtils.hideProgressDialog();
    ...
    protected void onResume()
    {
        ...
        Pgscholarsapprovelist(1, isChecked_API);
    ...
    private void initView() {
        ...
        lvpgscholar = (ListView) findViewById(R.id.lv_pg_scholar);
