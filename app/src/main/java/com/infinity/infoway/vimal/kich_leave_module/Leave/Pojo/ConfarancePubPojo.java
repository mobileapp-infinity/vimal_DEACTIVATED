...
public class ConfarancePubPojo
{
    ...
    public static class DataBean {
         ...
         * status : Pending
         * create_by : Himanit
         * create_date : 2019-12-09T15:04:13.527
         * year_name : 2020-21
         * ipc_paper_title : A
         * ipc_conference_title : B
         * ipc_conference_name : C
         * ipc_level : International
         * ipc_publication_date : 01/12/2019
         * ipc_isbn_issn_number : D
         * ipc_publisher_name : E
         * ipc_file_upload : http://rku.ierp.co.in/download_file.aspx?PathToFile=D:\datahost\rku.ierp.co.in\data\app/BookPublication/13/COSEC WEB API V1.0 (1).pdf
         * approve_reject_by_user : null
         * approve_rejct_date : null
         */

        private String SrNo;
        private String emp_parent_id;
        private String id;
        ...
        public String getEmp_parent_id() {
            return emp_parent_id;
        }

        public void setEmp_parent_id(String emp_parent_id) {
